...
const auth = {
    ...
    updateUserUI() {
        ...
        if (userRoleEl) userRoleEl.textContent = this.currentUser.role === 'admin' ? 'Administrator' : 'Siswa/Karyawan';
    ...
    async openProfileModal() {
        ...
        if (user.role === 'siswa/karyawan' || user.role !== 'admin') {
